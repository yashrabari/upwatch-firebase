...
import 'package:upwatch/screen/disease_risk_screen/gradiant_pie_chart/pie_option.dart';
import 'package:upwatch/screen/disease_risk_screen/gradiant_pie_chart/utils.dart';

import 'chart_painter.dart';
import 'chart_value_option.dart';
import 'degree.dart';
import 'legend.dart';
...
class GradiantPieChart extends StatefulWidget {
  const GradiantPieChart({
  ...
  _GradiantPieChartState createState() => _GradiantPieChartState();
}

class _GradiantPieChartState extends State<GradiantPieChart> with SingleTickerProviderStateMixin {
      ...
      child: LayoutBuilder(
        builder: (_, c) => SizedBox(
          height: widget.chartRadius != null
              ...
              : null,
          child: CustomPaint(
            painter: PieChartPainter(_animFraction, widget.chartValuesOptions!.showChartValues, widget.chartValuesOptions!.showChartValuesOutside, widget.colorList,
              ...
              .map(
                (item) => Legend(
                  ...
                  color: isGradientPresent
                      ? getGradient(widget.gradientList!, legendTitles!.indexOf(item), isNonGradientElementPresent: isNonGradientElementPresent, emptyColorGradient: widget.emptyColorGradient)[0]
                      : getColor(
                          widget.colorList,
  ...
  @override
  void didUpdateWidget(GradiantPieChart oldWidget) {
    initData();
